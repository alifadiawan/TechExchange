...
// FAQ Component for the interactive accordion
const FaqItem = ({ question, answer }) => {
    const [isOpen, setIsOpen] = useState(false);

    return (
        <motion.div layout className="border-l-4 border-emerald-500 pl-4 py-2 cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
            <motion.h3 layout className="text-xl font-medium text-white flex justify-between items-center">
                {question}
                <motion.div
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.p
                        className="text-gray-400 mt-2 pr-4"
...
const AboutPage = () => {
    const faqs = [
        {
            question: "Bagaimana Anda memastikan kualitas barang?",
            answer: "Setiap barang melewati proses inspeksi 15 poin yang ketat. Kami menguji fungsi, menilai kondisi fisik, dan memverifikasi keaslian sebelum barang dijual."
        },
        {
            question: "Apa kebijakan pengembalian barang?",
            answer: "Kami menawarkan garansi kepuasan 14 hari. Jika Anda tidak puas dengan pembelian Anda, Anda dapat mengembalikannya untuk pengembalian dana penuh atau penukaran."
        },
        {
            question: "Apakah saya bisa menjual perlengkapan gaming bekas di TechExchange?",
            answer: "Tentu saja! Buat akun, kirimkan foto dan detail barang Anda, dan tim kami akan meninjaunya dalam 48 jam. Setelah disetujui, barang Anda akan ditampilkan di marketplace kami."
        }
    ];
        ...
        <App>
            <div className="min-h-screen bg-zinc-900 text-gray-300">
                ...
                <div className="bg-zinc-800 py-16">
                    ...
                    >
                        <motion.h1 variants={itemVariants} className="text-4xl md:text-5xl font-bold text-white mb-4">Tentang TechExchange</motion.h1>
                        <motion.p variants={itemVariants} className="text-xl text-gray-400 max-w-3xl">
                ...
                >
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <motion.div variants={itemVariants}>
                            ...
                            <motion.div className="mt-8 flex flex-wrap gap-4" variants={sectionVariants}>
                                <motion.span variants={itemVariants} className="inline-block bg-emerald-500 text-white px-4 py-2 rounded font-medium">
                        ...
                        <motion.div className="bg-zinc-800 p-8 rounded-lg" variants={itemVariants} whileHover={{ y: -5 }}>
                            ...
                            <ul className="space-y-4">
                                <motion.li className="flex items-start" variants={itemVariants}>
                                    <div className="bg-emerald-600 rounded-full p-1 mr-3 mt-1 flex-shrink-0">
                ...
                <motion.div
                    ...
                    variants={sectionVariants}
                >
                    <h2 className="text-3xl font-bold text-white mb-8 text-center">Pertanyaan yang Sering Diajukan</h2>
                ...
                <div className="bg-zinc-800 py-16">
                    ...
                    >
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <motion.div variants={itemVariants}>
                                ...
                                <motion.div className="space-y-4" variants={sectionVariants}>
                                    <motion.div className="flex items-center" variants={itemVariants}>
                                        <motion.div className="bg-emerald-600 rounded-full p-2 mr-4" variants={iconVariants}>
                            ...
                            <motion.div className="bg-zinc-900 p-6 rounded-lg" variants={itemVariants}>
                                <h3 className="text-xl font-bold text-white mb-4">Jam Operasional Kami</h3>
                                <div className="space-y-2 text-gray-400">
                                    <div className="flex justify-between"><span>Senin - Jumat</span><span>09.00 - 18.00 WIB</span></div>
                                    <div className="flex justify-between"><span>Sabtu</span><span>10.00 - 16.00 WIB</span></div>
                                ...
                                <div className="mt-8">
                                    ...
                                    <motion.div className="flex space-x-4" variants={sectionVariants}>
                                        <motion.a href="#" className="bg-emerald-600 text-white p-2 rounded-full hover:bg-emerald-500 transition" variants={iconVariants} whileHover={{ scale: 1.2, rotate: 10 }} whileTap={{ scale: 0.9 }}>
                        ...
                        <motion.div className="max-w-md mx-auto" variants={itemVariants}>
                            <div className="flex flex-col sm:flex-row gap-3">
                                <motion.input
                                    ...
                                    whileFocus={{ borderColor: '#10B981', boxShadow: '0 0 0 2px rgba(16, 185, 129, 0.5)' }}
                                />
                                <motion.button
                                    className="bg-emerald-500 text-white font-medium px-6 py-3 rounded"
