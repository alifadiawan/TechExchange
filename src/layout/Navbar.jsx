                ...
                <div className="flex justify-between h-16">
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:ml-6 md:flex md:space-x-8">
                            ...
                            <a href="#" className="border-transparent hover:border-gray-300 border-b-2 hover:text-gray-300 px-1 pt-1 text-sm font-medium">Sell</a>
                            <a href="#" className="border-transparent hover:border-gray-300 border-b-2 hover:text-gray-300 px-1 pt-1 text-sm font-medium">About</a>
                        </div>
                    </div>
                    <div className="flex items-center">
